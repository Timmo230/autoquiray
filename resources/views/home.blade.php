        ...
        <div class="container pt-5 pb-5 position-relative" style="z-index: 2;">
            ...
            <div class="row justify-content-center text-center mt-5 g-3">
                <div class="col-12 col-sm-6 col-md-auto">
                    <a class="btn btn-green-btn rounded-pill px-5 py-3 text-light fs-5-5 fw-bold arriba w-sm-100 d-flex align-items-center justify-content-center" href="/tipos_de_test" data-plausible-event="home_tests_cta_clicked">
                        <i class="fa-regular fa-file-lines me-2"></i>Acceder a mis tests
                    </a>
                </div>

                <div class="col-12 col-sm-6 col-md-auto">
                    <a class="btn btn-outline-light rounded-pill px-5 py-3 fw-bold fs-5-5 arriba w-sm-100 d-flex align-items-center justify-content-center shadow-sm" id="iniciarSesion" href="{{ route('login', absolute: false) }}" data-plausible-event="home_login_cta_clicked">
